...
const bootLines = [
  { text: "BIOS v3.14.159 — SjxSubhamOS Kernel", delay: 0 },
  ...
  { text: "[  OK  ] Mounting /home/sjxsubham/projects", delay: 1350 },
  ...
  { text: "", delay: 2500 },
  {
    text: "  Welcome to SjxSubhamOS v2.0 — Full Stack Developer Environment",
    delay: 2600,
  },
...
const Boot = ({ onBootComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Progress bar */}
      <div
        className={`w-full max-w-3xl px-6 mt-4 transition-opacity duration-500 ${
          phase === "complete" ? "opacity-0" : "opacity-100"
        }`}
      >
